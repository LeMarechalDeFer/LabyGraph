...
int main() {
    ...
    while (!WindowShouldClose()) {
        ...
        if (player.currentNode == 99) {
            ...
            lastKeyPressTime = currentTime;  // Mettre à jour le temps de la dernière action // Terminer la boucle de jeu
    ...
    switch (currentScreen) {
        ...
        if (IsKeyPressed(KEY_K))
                ...
                /////////////////////////////////////////
        // Rendu du labyrinthe
        RenderMaze(&maze, cellSize); //RenderMaze(&maze, screenWidth, screenHeight, cellSize);
        ...
        ////////
                    ...
                    Rectangle rec_player = { 1150, 83, 420, 200 };  // Utilise la structure Rectangle pour déclarer
                    ...
                    DrawText("Statistique Player:",1170,90,20,BLACK); //mettre la barre de vie 
